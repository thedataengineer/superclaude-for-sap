...
tools: [Read, Grep, Glob, Bash, Edit, Write, WebFetch, WebSearch, mcp__plugin_prism_sap__GetPackage, mcp__plugin_prism_sap__GetPackageContents, mcp__plugin_prism_sap__GetPackageTree, mcp__plugin_prism_sap__GetObjectsByType, mcp__plugin_prism_sap__SearchObject, mcp__plugin_prism_sap__GetTable, mcp__plugin_prism_sap__GetStructure, mcp__plugin_prism_sap__GetDataElement, mcp__plugin_prism_sap__GetDomain, mcp__plugin_prism_sap__GetView, mcp__plugin_prism_sap__GetClass, mcp__plugin_prism_sap__GetInterface, mcp__plugin_prism_sap__GetProgram, mcp__plugin_prism_sap__GetFunctionModule, mcp__plugin_prism_sap__GetFunctionGroup, mcp__plugin_prism_sap__GetInclude, mcp__plugin_prism_sap__GetBehaviorDefinition, mcp__plugin_prism_sap__GetBehaviorImplementation, mcp__plugin_prism_sap__GetServiceDefinition, mcp__plugin_prism_sap__GetServiceBinding, mcp__plugin_prism_sap__GetMetadataExtension, mcp__plugin_prism_sap__GetScreen, mcp__plugin_prism_sap__GetGuiStatus, mcp__plugin_prism_sap__GetTextElement, mcp__plugin_prism_sap__GetEnhancements, mcp__plugin_prism_sap__GetEnhancementImpl, mcp__plugin_prism_sap__GetEnhancementSpot, mcp__plugin_prism_sap__GetUnitTest, mcp__plugin_prism_sap__GetCdsUnitTest, mcp__plugin_prism_sap__GetLocalTestClass, mcp__plugin_prism_sap__GetLocalDefinitions, mcp__plugin_prism_sap__GetLocalTypes, mcp__plugin_prism_sap__GetLocalMacros, mcp__plugin_prism_sap__GetWhereUsed, mcp__plugin_prism_sap__GetObjectInfo, mcp__plugin_prism_sap__GetObjectStructure, mcp__plugin_prism_sap__GetAbapSemanticAnalysis, mcp__plugin_prism_sap__GetAbapAST, mcp__plugin_prism_sap__GetInactiveObjects, mcp__plugin_prism_sap__GetTransport, mcp__plugin_prism_sap__ListTransports, mcp__plugin_prism_sap__GetTypeInfo, mcp__plugin_prism_sap__GetAdtTypes, mcp__plugin_prism_sap__GetIncludesList, mcp__plugin_prism_sap__GetScreensList, mcp__plugin_prism_sap__GetGuiStatusList, mcp__plugin_prism_sap__GetProgFullCode, mcp__plugin_prism_sap__ReadClass, mcp__plugin_prism_sap__ReadProgram, mcp__plugin_prism_sap__ReadFunctionModule, mcp__plugin_prism_sap__ReadFunctionGroup, mcp__plugin_prism_sap__ReadInterface, mcp__plugin_prism_sap__ReadStructure, mcp__plugin_prism_sap__ReadTable, mcp__plugin_prism_sap__ReadDataElement, mcp__plugin_prism_sap__ReadDomain, mcp__plugin_prism_sap__ReadView, mcp__plugin_prism_sap__ReadBehaviorDefinition, mcp__plugin_prism_sap__ReadBehaviorImplementation, mcp__plugin_prism_sap__ReadServiceDefinition, mcp__plugin_prism_sap__ReadServiceBinding, mcp__plugin_prism_sap__ReadMetadataExtension, mcp__plugin_prism_sap__ReadScreen, mcp__plugin_prism_sap__ReadPackage, mcp__plugin_prism_sap__ReadGuiStatus, mcp__plugin_prism_sap__CreateClass, mcp__plugin_prism_sap__CreateProgram, mcp__plugin_prism_sap__CreateFunctionGroup, mcp__plugin_prism_sap__CreateFunctionModule, mcp__plugin_prism_sap__CreateInterface, mcp__plugin_prism_sap__CreateInclude, mcp__plugin_prism_sap__CreateStructure, mcp__plugin_prism_sap__CreateTable, mcp__plugin_prism_sap__CreateDataElement, mcp__plugin_prism_sap__CreateDomain, mcp__plugin_prism_sap__CreateView, mcp__plugin_prism_sap__CreateBehaviorDefinition, mcp__plugin_prism_sap__CreateBehaviorImplementation, mcp__plugin_prism_sap__CreateServiceDefinition, mcp__plugin_prism_sap__CreateServiceBinding, mcp__plugin_prism_sap__CreateMetadataExtension, mcp__plugin_prism_sap__CreateScreen, mcp__plugin_prism_sap__CreateGuiStatus, mcp__plugin_prism_sap__CreateTextElement, mcp__plugin_prism_sap__CreateUnitTest, mcp__plugin_prism_sap__CreateCdsUnitTest, mcp__plugin_prism_sap__CreatePackage, mcp__plugin_prism_sap__CreateTransport, mcp__plugin_prism_sap__UpdateClass, mcp__plugin_prism_sap__UpdateProgram, mcp__plugin_prism_sap__UpdateFunctionGroup, mcp__plugin_prism_sap__UpdateFunctionModule, mcp__plugin_prism_sap__UpdateInterface, mcp__plugin_prism_sap__UpdateInclude, mcp__plugin_prism_sap__UpdateStructure, mcp__plugin_prism_sap__UpdateTable, mcp__plugin_prism_sap__UpdateDataElement, mcp__plugin_prism_sap__UpdateDomain, mcp__plugin_prism_sap__UpdateView, mcp__plugin_prism_sap__UpdateBehaviorDefinition, mcp__plugin_prism_sap__UpdateBehaviorImplementation, mcp__plugin_prism_sap__UpdateServiceDefinition, mcp__plugin_prism_sap__UpdateServiceBinding, mcp__plugin_prism_sap__UpdateMetadataExtension, mcp__plugin_prism_sap__UpdateScreen, mcp__plugin_prism_sap__UpdateGuiStatus, mcp__plugin_prism_sap__UpdateTextElement, mcp__plugin_prism_sap__UpdateUnitTest, mcp__plugin_prism_sap__UpdateCdsUnitTest, mcp__plugin_prism_sap__UpdateLocalDefinitions, mcp__plugin_prism_sap__UpdateLocalTypes, mcp__plugin_prism_sap__UpdateLocalMacros, mcp__plugin_prism_sap__UpdateLocalTestClass, mcp__plugin_prism_sap__DeleteClass, mcp__plugin_prism_sap__DeleteProgram, mcp__plugin_prism_sap__DeleteFunctionGroup, mcp__plugin_prism_sap__DeleteFunctionModule, mcp__plugin_prism_sap__DeleteInterface, mcp__plugin_prism_sap__DeleteInclude, mcp__plugin_prism_sap__DeleteStructure, mcp__plugin_prism_sap__DeleteTable, mcp__plugin_prism_sap__DeleteDataElement, mcp__plugin_prism_sap__DeleteDomain, mcp__plugin_prism_sap__DeleteView, mcp__plugin_prism_sap__DeleteBehaviorDefinition, mcp__plugin_prism_sap__DeleteBehaviorImplementation, mcp__plugin_prism_sap__DeleteServiceDefinition, mcp__plugin_prism_sap__DeleteServiceBinding, mcp__plugin_prism_sap__DeleteMetadataExtension, mcp__plugin_prism_sap__DeleteScreen, mcp__plugin_prism_sap__DeleteGuiStatus, mcp__plugin_prism_sap__DeleteTextElement, mcp__plugin_prism_sap__DeleteUnitTest, mcp__plugin_prism_sap__DeleteCdsUnitTest, mcp__plugin_prism_sap__DeleteLocalDefinitions, mcp__plugin_prism_sap__DeleteLocalTypes, mcp__plugin_prism_sap__DeleteLocalMacros, mcp__plugin_prism_sap__DeleteLocalTestClass, mcp__plugin_prism_sap__RunUnitTest, mcp__plugin_prism_sap__GetUnitTestResult, mcp__plugin_prism_sap__GetUnitTestStatus, mcp__plugin_prism_sap__ValidateServiceBinding]
---
...
<Agent_Prompt>
  ...
  **MANDATORY — highest priority.** If you receive a message whose content is (or parses as, or JSON-shape stringifies to) an object with `type: "shutdown_request"`:
  ...
  <Success_Criteria>
    ...
    - Syntax matches the configured `abapRelease` in `.prism/config.json`
  </Success_Criteria>
  ...
  <Shared_Conventions>
    **Source of truth for every coding rule lives in `../common/`. Do NOT re-derive or paraphrase these rules; read the referenced file and apply it literally.**
    ...
    | **Mandatory main-program template** | `../common/oop-sample/zrprism_oop_ex.prog.abap` (OOP) **OR** `../common/procedural-sample/main-program.abap` (Procedural) | Phase 4 Wave 3 main-program generation — copy the skeleton, adapt identifiers, do NOT restructure without a documented justification in `spec.md` |
    ...
    | Transport client rule (`CreateTransport` must always receive explicit `client` from `.prism/sap.env` SAP_CLIENT) | [`../common/transport-client-rule.md`](../common/transport-client-rule.md) | Any `CreateTransport` MCP call |
